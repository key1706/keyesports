...
"></span> Chưa Xem</button> </a>
                <a href="nhanxet-daxem.php"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Đã Xem</button> </a>
                <h2 class="inner-tittle">Nhận Xét Đã Xem</h2>
                <table class="table table-bordered">
                    ...
                    ?>
                        <tr class="success" style="text-align: center;">
                            ...
                            <td>{NoiDung}</td>
                            <td>
                                    <button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-ok"></span> Đã Xem</button>
                            </td>
                            <td>
                                <a href="xoaNhanxet.php?id={id}">
